...
class TransOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('-o', '--output',type=str ,default=None,help='Format detail..`$expy -o -h`')
        self.parser.add_argument('--to'          ,type=str ,default=None,help='Format detail..`$expy -o -h`(-p is equal --to)')
